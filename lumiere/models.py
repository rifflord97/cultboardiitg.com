...
class Club_sec(models.Model):
    image = models.FileField(upload_to='./lumiere/cs')
...
class Gallery(models.Model):
    image = models.FileField(upload_to='./lumiere/gallery')
...
class Club_Member(models.Model):
    image1 = models.FileField(upload_to='./lumiere/cm',blank=True, null=True)
    ...
    image2 = models.FileField(upload_to='./lumiere/cm', blank=True, null=True)
    ...
    image3 = models.FileField(upload_to='./lumiere/cm', blank=True, null=True)
