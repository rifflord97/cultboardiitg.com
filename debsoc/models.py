...
class Club_sec(models.Model):
    image = models.FileField(upload_to='./debsoc/cs')
...
class Gallery(models.Model):
    image = models.FileField(upload_to='./debsoc/gallery')
...
class Club_Member(models.Model):
    image1 = models.FileField(upload_to='./debsoc/cm',blank=True, null=True)
    ...
    image2 = models.FileField(upload_to='./debsoc/cm', blank=True, null=True)
    ...
    image3 = models.FileField(upload_to='./debsoc/cm', blank=True, null=True)
