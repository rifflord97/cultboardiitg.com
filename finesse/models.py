...
class Club_sec(models.Model):
    image = models.FileField(upload_to='./finesse/cs')
...
class Gallery(models.Model):
    image = models.FileField(upload_to='./finesse/gallery')
...
class Club_Member(models.Model):
    image1 = models.FileField(upload_to='./finesse/cm',blank=True, null=True)
    ...
    image2 = models.FileField(upload_to='./finesse/cm', blank=True, null=True)
    ...
    image3 = models.FileField(upload_to='./finesse/cm', blank=True, null=True)
